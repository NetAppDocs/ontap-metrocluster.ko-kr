...
+
image::../media/mcc_dr_groups_8_node_with_a_single_controller_failure.gif[단일 컨트롤러 장애가 있는 8개 노드 MetroCluster DR 그룹]
...
image::../media/mcc_dr_groups_8_node_with_a_multi_controller_failure.gif[다중 컨트롤러 장애가 있는 8개 노드 MetroCluster DR 그룹]
...
image::../media/mcc_dr_groups_8_node_with_two_single_controller_failures.gif[2개의 단일 컨트롤러 오류가 있는 8개 노드 MetroCluster DR 그룹]
...
image::../media/mcc_dr_groups_8_node_with_a_3_controller_failure.gif[3개의 컨트롤러 오류가 있는 8개 노드 MetroCluster DR 그룹]
...
image::../media/mcc_dr_groups_2_node_with_a_single_controller_failure.gif[단일 컨트롤러 장애가 있는 2노드 MetroCluster DR 그룹]
