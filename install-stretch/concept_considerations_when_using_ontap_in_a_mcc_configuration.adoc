...
+
image::../media/svm_dr_normal_behavior.gif[정상 상태 작동 중 SVM 재해 복구]
...
+
image::../media/svm_dr_image_2.gif[전환 후 SVM 업데이트]
...
image::../media/svm_dr_resynchronization.gif[SVM 재해 복구 재동기화]
