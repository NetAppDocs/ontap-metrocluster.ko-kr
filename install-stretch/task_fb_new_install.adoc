...
image::../media/workflow_bridge_installation_and_configuration.gif[FC-SAS 브리지 설치 및 구성을 위한 워크플로]
...
image::../media/mcc_cabling_bridge_and_sas3_stack_with_7500n_and_multiple_stacks.gif[여러 SAS3 스택을 사용한 MetroCluster 케이블링 FibreBridge 구성]
