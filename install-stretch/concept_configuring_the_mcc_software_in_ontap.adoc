...
| 정보 유형입니다 | 당신의 가치 
 ...
 a| 
클러스터 이름입니다. 이 설명서에 사용된 예: site_a
 a| 
...
| 노드 | 포트 | IP 주소입니다 | 네트워크 마스크 | 기본 게이트웨이 
 ...
 a| 
노드 1. 이 설명서에 사용된 예: controller_a_1
 a| 
 a| 
 a| 
 a| 
...
| 정보 유형입니다 | 당신의 가치 
 ...
 a| 
클러스터 이름입니다. 본 가이드에 사용된 예: site_B
 a| 
...
| 노드 | 포트 | IP 주소입니다 | 네트워크 마스크 | 기본 게이트웨이 
 ...
 a| 
노드 1. 이 설명서에 사용된 예: controller_B_1
 a| 
 a| 
 a| 
 a| 
...
link:concept_preparing_for_the_mcc_installation.html["전용 포트를 사용할 때의 고려 사항"]

link:concept_preparing_for_the_mcc_installation.html["데이터 포트 공유 시 고려 사항"]
