...
image::../media/mcc_hw_architecture_local_ha.gif[MetroCluster 구성의 로컬 HA]
...
image::../media/mcc_mirroring_of_svms.gif[SVM의 MetroCluster 미러링]

스위치오버가 발생하면 작동하는 클러스터의 원격 플렉스에서 온라인 상태가 되고 보조 SVM에서 데이터 서비스를 시작합니다.

image::../media/mcc_svms_after_switchover.gif[전환 후 MetroCluster SVM]
...
image::../media/mcc_mirroring_of_pools.gif[스토리지 풀의 MetroCluster 미러링]
...
| MetroCluster 구성에서 | 비 MetroCluster HA 2노드에 대해 설명합니다 
 ...
 a| 
image:../media/mcc_nvram_quartering.gif["MetroCluster 구성에서 비휘발성 캐시 분기화"]
 a| 
image:../media/mcc_nvram_split_in_non_mcc_ha_pair.gif["비휘발성 캐시가 MetroCluster HA 쌍이 아닌 쌍으로 분할됨"]
...
image::../media/mcc_nvram_mirroring_example.gif[MetroCluster NVRAM 미러링 예제]
...
image::../media/mcc_nvram_mirroring_example_dynamic_dr_aux.gif[DR 보조 기능을 갖춘 MetroCluster NVRAM 미러링]
...
image::../media/mcc_disk_ownership.gif[MetroCluster 디스크 소유권]
...
image::../media/mcc_so_sb_with_autoheal.gif[자동 복구를 통한 MetroCluster 전환 및 스위치백]
...
image::../media/mcc_uso_with_autoheal.gif[자동 복구를 통한 MetroCluster 예정되지 않은 전환]
