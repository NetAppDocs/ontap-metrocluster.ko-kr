...
펌웨어 업그레이드
 a| 
link:maintain/task_upgrade_firmware_on_mcc_ip_switches.html["MetroCluster IP 스위치에서 펌웨어를 업그레이드합니다"]
...
RCF 파일 업그레이드
 a| 
link:maintain/task_upgrade_rcf_files_on_mcc_ip_switches.html["MetroCluster IP 스위치에서 RCF 파일을 업그레이드합니다"]

link:maintain/task_upgrade_rcf_files_on_cisco_ip_switches_with_cleanupfiles.html["CleanUpFiles를 사용하여 Cisco IP 스위치에서 RCF 파일을 업그레이드합니다"]
...
스위치 이름을 바꿉니다
 a| 
link:maintain/task_rename_a_cisco_ip_switch.html["Cisco IP 스위치의 이름을 바꿉니다"]
