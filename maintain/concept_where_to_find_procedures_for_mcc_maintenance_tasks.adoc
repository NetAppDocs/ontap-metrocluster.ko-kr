...
NOTE: ONTAP 9.8이 출시됨에 따라 MetroCluster 업그레이드 및 확장 절차가 로 옮겨졌습니다 link:../upgrade/index.html["MetroCluster 업그레이드 및 확장"] 및 link:../transition/index.html["MetroCluster FC에서 MetroCluster IP로 전환합니다"].
