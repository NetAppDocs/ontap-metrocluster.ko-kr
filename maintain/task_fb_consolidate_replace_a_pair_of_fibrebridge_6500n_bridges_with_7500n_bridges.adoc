...
image::../media/consolidating_stacks_before.gif[FibreBridge 교체 전 스택 통합]
...
+
image::../media/consolidating_stacks_1st_7500n_in_place.gif[첫 번째 FibreBridge 7500N을 사용하여 스택 통합]
...
** 지금은 FibreBridge 7600N 또는 7500N 브리지 FC1 포트를 연결하지 마세요.image:../media/consolidating_stacks_2nd_7500n_in_place.gif["두 번째 FibreBridge 7500N을 사용하여 스택 통합"]
...
+
image::../media/consolidating_stacks_sas_top_before.gif[FibreBridge 7500N에 케이블링하기 전에 SAS 스택 통합]
...
+
image::../media/consolidating_stacks_sas_top_after.gif[통합 후 SAS 상단 케이블링]
...
+
image::../media/consolidating_stacks_sas_bottom_before.gif[하단 선반 통합 전 녹색 SAS 케이블링]
...
+
image::../media/consolidating_stacks_sas_bottom_after.gif[통합 후 SAS 하단 케이블링]
...
+
image::../media/consolidation_sas_bottom_connection_4_stacks.gif[4개 스택을 위한 SAS 하단 케이블링]
...
image::../media/zoning_consolidation_site_a_before.gif[FibreBridge 변경 전 사이트 A의 구역 통합]
...
image::../media/zoning_consolidation_site_a_after.gif[FibreBridge 변경 후 사이트 A의 구역 통합]
...
+
image::../media/consolidating_stacks_sas_ports_recabled.gif[FC_switch_A_2에 통합 후 FC2 포트 케이블링]

. 하단 브리지의 FC1 포트를 FC_SWITCH_A_1의 올바른 포트에 연결합니다.
+
image::../media/consolidating_stacks_final.gif[최종 스택 통합 케이블링]
