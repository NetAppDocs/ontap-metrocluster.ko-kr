...
.단계
. 사용 https://["패브릭 연결 MetroCluster 설치 및 구성"^] 8노드 MetroCluster 구성의 포트 사용을 사용하여 스위치 유형의 케이블 연결 레이아웃을 확인합니다.
+
...
FC 스위치 포트 사용량은 에 설명된 사용량과 일치해야 합니다 https://["패브릭 연결 MetroCluster 설치 및 구성"^] 따라서 RCFs를 사용할 수 있습니다.
...
. 에 설명된 협상된 전환, 복구 및 스위치백에 대한 절차를 사용합니다 https://["MetroCluster 관리 및 재해 복구"^].
