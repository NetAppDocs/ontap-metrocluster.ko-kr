...
. ISL 암호화를 활성화하려면 다음을 참조하세요. link:../install-fc/task_fcsw_brocade_configure_the_brocade_fc_switches_supertask.html#set-isl-encryption-on-brocade-6510-or-g620-switches["Brocade FC 스위치를 수동으로 구성합니다"] .
+
