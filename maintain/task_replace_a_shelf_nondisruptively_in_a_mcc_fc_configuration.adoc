...
+
image::../media/mcc_shelf_replacement_bridges_with_a_single_stack.gif[싱글 스택이 있는 선반 교체 브리지]
...
+
image::../media/mcc_shelf_replacement_bridges_with_four_stacks.gif[4개의 스택이 있는 선반 교체 브리지]
