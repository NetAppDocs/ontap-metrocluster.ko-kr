...
NOTE: 스위치가 이미 올바르게 구성된 경우 다음 섹션을 건너뛰고 로 바로 이동할 수 있습니다 <<Configuring MACsec encryption on Cisco 9336C switches>>, 해당되는 경우 또는 에 <<Connecting the new NS224 shelf>>.
