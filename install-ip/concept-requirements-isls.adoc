...
+
** ONTAP 9.18.1 버전부터 MetroCluster IP 백엔드 포트 속도가 100G인 플랫폼은 최소 100Gbps의 ISL 링크 속도가 필요합니다. 다른 ISL 속도를 사용하려면 기능 변경 요청(FPVR)이 필요합니다. FPVR을 제출하려면 NetApp 영업팀에 문의하십시오.
