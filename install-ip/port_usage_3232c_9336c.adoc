...
AFF A20 시스템을 Cisco 3232C 또는 9336C 스위치에 케이블로 연결하기 위한 플랫폼 포트 할당을 검토합니다.

image:../media/mcc-ip-cabling-aff-a20-9161.png["에는 Cisco 3232C 또는 Cisco 9336C 플랫폼 포트 할당이 나와 있습니다"]
...
image:../media/mcc-ip-cabling-a90-fas90-c80-fas70-a70-a1k-cisco-3232C-or-9336c-switch-updated.png["에는 Cisco 3232C 또는 Cisco 9336C 플랫폼 포트 할당이 나와 있습니다"]
