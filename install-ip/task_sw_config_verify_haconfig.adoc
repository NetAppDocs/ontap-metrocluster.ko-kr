...
link:concept_mediator_requirements.html["계획되지 않은 자동 전환을 위해 ONTAP 중재자 서비스를 구성합니다"]
...
link:concept_considerations_differences.html["ONTAP 중재자 또는 MetroCluster Tiebreaker를 사용할 때의 고려 사항"]
