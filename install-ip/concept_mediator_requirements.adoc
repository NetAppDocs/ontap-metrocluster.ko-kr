...
* ONTAP 9.19.1 및 ONTAP Mediator 1.12 버전부터 iSCSI 대신 HTTPS를 사용하여 통신하는 ONTAP Mediator를 구성할 수 있습니다. ONTAP Mediator를 HTTPS로 구성하면 ONTAP Mediator 인스턴스당 하나의 MetroCluster IP 구성만 모니터링할 수 있습니다. 자세한 내용은 <<ONTAP Mediator에 사용할 통신 프로토콜을 선택하십시오>>을 참조하십시오.
...
====
자세한 내용은 link:https://docs.netapp.com/us-en/ontap/mediator/index.html#https-iscsi-installation["ONTAP Mediator의 HTTPS 및 iSCSI 설치 옵션"^]를 참조하십시오.
