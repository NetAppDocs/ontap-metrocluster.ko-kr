...
| AFF A320 FAS8300, AFF C400, ASA C400, FAS8700 AFF A900, ASA A900 | <<table_7_cisco_9336c_fx2,Cisco 9336C-FX2 공유 스위치 플랫폼 포트 할당(그룹 7)>> 
...
image::../media/mcc_ip_cabling_a_aff_a150_asa_a150_fas27500_aff_a220_to_a_cisco_9336c_shared_switch.png[에는 Cisco 9336C-FX2 공유 스위치 플랫폼 포트 할당이 나와 있습니다]
...
image::../media/mcc_ip_cabling_c250_asa_c250_a250_asa_a250_to_cisco_9336c_shared_switch.png[에는 Cisco 9336C-FX2 공유 스위치 플랫폼 포트 할당이 나와 있습니다]
...
image::../media/mcc_ip_cabling_fas8200_affa300_to_cisco_9336c_shared_switch.png[에는 Cisco 9336C-FX2 공유 스위치 플랫폼 포트 할당이 나와 있습니다]

.Cisco 9336C-FX2 공유 스위치 플랫폼 포트 할당(그룹 7)
AFF A320, FAS8300, AFF C400, ASA C400, FAS8700, 스위치 연결 NSS24 쉘프를 Cisco 9336C-FX2 공유 스위치에 연결하지 않는 AFF A900 또는 ASA A900 시스템:
