...
* NS224 스토리지를 연결하는 Cisco 9336C-FX2 스위치를 케이블로 연결할 때 최대 2개의 MetroCluster 구성 또는 DR 그룹만 사용할 수 있습니다. 최소 하나의 MetroCluster 구성 또는 DR 그룹은 NS224 쉘프를 MetroCluster 스위치에 연결해야 합니다. MetroCluster 구성 또는 DR 그룹 중 하나가 NS224 쉘프를 지원하지 않는 시스템인 경우 두 번째 MetroCluster 구성 또는 DR 그룹으로만 연결할 수 있습니다.
+
