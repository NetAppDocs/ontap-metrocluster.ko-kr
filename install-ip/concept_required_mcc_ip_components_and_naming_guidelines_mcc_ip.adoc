...
| AFF A900 및 FAS9500 | X91146A | 슬롯 5, 슬롯 7 | e5b, e7b 
...
사용 중인 ONTAP 버전은 쉘프 혼합을 지원해야 합니다. 을 참조하십시오 https://["NetApp 상호 운용성 매트릭스 툴(IMT)"] 사용 중인 ONTAP 버전이 쉘프 혼합을 지원하는지 확인하려면 다음을 참조하십시오.

쉘프 혼합에 대한 자세한 내용은 를 참조하십시오 https://["IOM6 모듈을 사용해 쉘프 스택에 IOM12 모듈을 장착한 상태로 쉘프 추가"]
