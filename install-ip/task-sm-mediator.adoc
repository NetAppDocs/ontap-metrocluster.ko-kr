...
NOTE: HTTPS를 사용하는 ONTAP Mediator는 CLI를 통해서만 구성할 수 있습니다. System Manager는 지원되지 않습니다. 자세한 내용은 link:concept_mediator_requirements.html#select-a-communication-protocol-for-ontap-mediator["ONTAP Mediator에 사용할 통신 프로토콜을 선택하십시오"]을 참조하십시오.
