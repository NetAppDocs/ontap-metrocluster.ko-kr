...
. 컨트롤러 하드웨어 업그레이드 익스프레스 가이드 _ 의 다음 절차를 사용하여 이전 노드에서 새 노드로 데이터를 이동합니다.
+
https://docs.netapp.com/platstor/topic/com.netapp.doc.hw-upgrade-controller/home.html["기타 플랫폼 절차: 컨트롤러 하드웨어 업그레이드 익스프레스 가이드"]
