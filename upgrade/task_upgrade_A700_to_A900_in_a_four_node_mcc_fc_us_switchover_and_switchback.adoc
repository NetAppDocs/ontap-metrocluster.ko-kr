...
. 다음 단계를 사용하세요. link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-mcc-config-tb["MetroCluster 구성 추가"] _MetroCluster Tiebreaker 설치 및 구성_ 섹션에서.
