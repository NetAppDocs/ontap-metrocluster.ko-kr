...
+
자세한 내용은 를 참조하십시오 https://["NetApp Hardware Universe를 참조하십시오"^]
...
+
http://["MetroCluster 구성을 제거하는 중입니다"]
...
. 의 단계를 사용합니다 http://["MetroCluster 구성 추가"^] In_MetroCluster Tiebreaker 설치 및 구성 _.
