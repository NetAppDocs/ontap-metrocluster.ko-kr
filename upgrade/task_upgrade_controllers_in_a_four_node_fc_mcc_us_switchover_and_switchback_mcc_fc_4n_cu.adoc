...
+
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#remove-metrocluster-configurations["MetroCluster 구성을 제거합니다"]
...
image::../media/mcc_upgrade_cluster_a_in_switchover.png[MetroCluster 전환 후 Site_B가 비활성화되어 업그레이드 준비가 되었습니다.]
...
. 루트 볼륨 암호화를 사용하는 경우, 사용 중인 ONTAP 버전에 따라 키 관리 구성에 대한 부팅 메뉴 옵션을 선택하거나 부팅 메뉴 명령을 다시 실행합니다.
+
[role="tabbed-block"]
====
.ONTAP 9.8 이상
...
image::../media/mcc_upgrade_cluster_a_switchback.png[MetroCluster 스위치백 후 업그레이드를 기다리는 Site_A]
