...
* 이 절차는 특정 ONTAP 버전에서 사용할 수 있습니다.
+
** ONTAP 9.3 이상에서는 2노드 구성이 지원됩니다.
** ONTAP 9.8 이상에서는 4개 및 8개 노드 구성이 지원됩니다.
+
...
NOTE: 원래 또는 새 플랫폼이 FC-VI 모드에서 1c/1d 포트를 사용하는 8020 시스템인 경우 기술 지원 부서에 문의하십시오.

* 이 절차는 MetroCluster FC 구성의 컨트롤러 모듈(2노드 스트레치 MetroCluster 또는 2노드 또는 4노드 패브릭 연결 MetroCluster 구성)에 적용됩니다.
