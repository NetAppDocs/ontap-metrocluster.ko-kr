...
+
** 다음 표에는 지원되는 플랫폼 모델 조합이 나와 있습니다.
...
[NOTE]
====
* BES-53248 IP 스위치를 사용하는 경우 AFF A320 플랫폼 모델은 업그레이드가 지원되지 않습니다.
...
====
image::../media/supported_controller_upgrades_mccip_sosb.png[지원되는 컨트롤러 업그레이드 mcip sosb]
