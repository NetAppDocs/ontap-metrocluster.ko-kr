...
+
** link:../install-ip/task_switch_config_broadcom.html["Broadcom RCF 파일을 다운로드하여 설치합니다"]
...
** link:../install-ip/task_switch_config_broadcom.html["Broadcom RCF 파일을 다운로드하여 설치합니다"]
** link:../install-ip/task_switch_config_cisco.html["Cisco IP RCF 파일을 다운로드하고 설치합니다"]
** link:../install-ip/task_switch_config_nvidia.html["NVIDIA IP SN2100 스위치 RCF 파일을 다운로드하고 설치합니다"]
