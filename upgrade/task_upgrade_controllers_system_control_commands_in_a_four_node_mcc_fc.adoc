...
* 온보드 포트 0e 및 0f를 FC-VI 연결로 AFF A300 또는 FAS8200 플랫폼의 업그레이드는 ONTAP 9.9.1 이전 버전을 실행하는 시스템에서만 지원됩니다. 자세한 내용은 를 참조하십시오 link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/BURT/1507088["공개 보고서"].
