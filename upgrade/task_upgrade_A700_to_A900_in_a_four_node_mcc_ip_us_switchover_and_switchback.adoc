...
---
= 스위치오버 및 스위치백을 사용하여 MetroCluster IP 구성에서 AFF A700/A900을 FAS9x00으로 컨트롤러 업그레이드(ONTAP 9.10.1 이상)
:allow-uri-read: 
...
AFF A700 또는 FAS9000의 MetroCluster IP 구성에서는 VLAN을 사용하지 않습니다. AFF A900 또는 FAS9500의 MetroCluster 구성에서는 VLAN을 사용합니다. 따라서 AFF A700 또는 FAS9000에서 AFF A900 또는 FAS9500으로 업그레이드할 때 RCF 파일을 변경해야 합니다.
