...
+
** 링크:../install-ip/task_switch_config_broadcom.html#reasing-the-broadcom-ip-switch-to-factory-defaults#reasing-the-broadcom-ip-switch-to-factory-defaults[Broadcom IP 스위치를 출하 시 기본값으로 재설정]
** 링크:../install-ip/task_switch_config_broadcom.html#재설정 - Broadcom-ip-switch-to-factory-defaults#재설정 - Cisco-IP-switch-to-factory-defaults[Cisco IP 스위치를 출하 시 기본값으로 재설정]
...
+
** 링크:../install-ip/task_switch_config_broadcom.html#reasing-the-broadcom-ip-switch-to-factory-defaults#downloading-and-installing-the-broadcom-rcf-files [RCF 파일 다운로드 및 설치]
** 링크:../install-ip/task_switch_config_broadcom.html#reasing-the-broadcom-ip-switch-to-factory-defaults#downloading-and-installing-the-cisco-ip-rcf-files [Cisco IP RCF 파일 다운로드 및 설치]
