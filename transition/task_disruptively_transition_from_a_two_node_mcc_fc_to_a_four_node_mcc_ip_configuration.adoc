...
+
4노드 MetroCluster FC 구성이 있는 경우 를 참조하십시오 xref:concept_choosing_your_transition_procedure_mcc_transition.adoc[전환 절차 선택].
...
+
을 참조하십시오 xref:concept_requirements_for_fc_to_ip_transition_2n_mcc_transition.adoc[FC-to-IP로 전환할 때 드라이브 쉘프를 재사용하고 요구사항을 고려해야 합니다].
