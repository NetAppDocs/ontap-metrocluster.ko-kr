...
+
라이센스 교체에 대한 자세한 내용은 를 참조하십시오 link:https://kb.netapp.com/Advice_and_Troubleshooting/Flash_Storage/AFF_Series/Post_Motherboard_Replacement_Process_to_update_Licensing_on_a_AFF_FAS_system["NetApp 기술 자료: AFF/FAS 시스템의 라이센스를 업데이트하기 위한 마더보드 교체 후 프로세스"^]
