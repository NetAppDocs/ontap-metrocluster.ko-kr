...
ONTAP 설정에 대한 자세한 내용은 를 참조하십시오 https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-ssg/home.html["ONTAP를 설정합니다"]
...
link:concept_prepare_for_the_mcc_installation.adoc["전용 포트를 사용할 때의 고려 사항"]
...
+
다음 예에서는 인터클러스터 LIF cluster01_icl01 및 cluster01_icl02를 생성합니다.
...
+다음 예제에서는 "e0c" 포트의 인터클러스터 LIF "cluster01_icl01" 및 "cluster01_icl02"가 "e0d" 포트로 페일오버되는 것을 보여 줍니다.
...
cluster01
         ...
         cluster01_icl02 cluster01-02:e0c   local-only      192.168.1.201/24
                            Failover Targets: cluster01-02:e0c,
                                              cluster01-02:e0d
----
link:concept_prepare_for_the_mcc_installation.adoc["데이터 포트 공유 시 고려 사항"]
...
+
RO 액세스가 필요한 경우, "User (ro):" 뒤에 "snmpv3user"를 지정합니다(예:
